...
//authorName, birthday, address, nickname
    ...
    public Author update(
            ...
            @WebParam(name = "address") String address,
            @WebParam(name = "nickname") String nickname) {
        EntityManagerFactory factory = Persistence.createEntityManagerFactory("WSLibrary22PU");
        ...
        try{
           // Query query = entitymanager.createNamedQuery("Author.findByAuthorId", Author.class);
            ...
            if(author != null){
                ...
                author.setAddress(address != null ? address : author.getAddress());
                author.setBirthday(birthday != null ? birthday : author.getBirthday());
                author.setNickname(nickname != null ? nickname : author.getNickname());
                em.persist(author);
                entityTransaction.commit();
                return author;
            }
